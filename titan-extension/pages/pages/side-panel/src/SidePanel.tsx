        ...
        <header className="header relative">
          <div className="header-logo">
            {showHistory ? (
              ...
              <span className={`font-semibold tracking-wider text-xs px-2 py-0.5 rounded ${isDarkMode ? 'bg-sky-950 text-sky-400 border border-sky-800' : 'bg-sky-100 text-sky-700 border border-sky-300'}`}>⚡ TITAN</span>
            )}
          </div>
